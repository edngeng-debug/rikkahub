(function(){
  ...
  function inject(menu,root){
    ...
    style.textContent=[
      ...
      '.dshwv-debug-mask{position:fixed!important;inset:0!important;width:100vw!important;height:100vh!important;max-width:none!important;max-height:none!important;background:rgba(15,23,42,.55);z-index:31000;display:flex;align-items:center;justify-content:center;color-scheme:light;box-sizing:border-box}',
      '.dshwv-debug-card{width:min(390px,92vw);max-height:86vh;overflow:auto;background:#fff;border-radius:12px;padding:16px;box-shadow:0 10px 30px rgba(0,0,0,.3);color:#203170;box-sizing:border-box}',
      '.dshwv-debug-title{font-size:15px;font-weight:700;text-align:center;margin-bottom:12px}',
      '.dshwv-debug-row{display:flex;align-items:center;gap:8px;margin:9px 0;font-size:12px}',
